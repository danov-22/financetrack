...
module.exports = async function handler(request, response) {
  try {
    ...
    const payment = indonesia
      ? { region: "ID", amountLabel: "Rp179,000", bankName: process.env.PAYMENT_ID_BANK_NAME || "", accountName: process.env.PAYMENT_ID_ACCOUNT_NAME || "", accountNumber: process.env.PAYMENT_ID_ACCOUNT_NUMBER || "", instructions: process.env.PAYMENT_ID_INSTRUCTIONS || "" }
